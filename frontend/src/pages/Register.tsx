    ...
    <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-start lg:gap-8">
      <Card className="rounded-[32px] p-6 sm:rounded-[36px] sm:p-10 lg:min-h-[280px]">
        ...
        <p className="section-copy mt-4">
          The browsing experience remains public, but actions that convert into orders or downloads require an account for security and tracking.
        </p>
      ...
      <Card className="rounded-[32px] p-6 sm:rounded-[36px] sm:p-10">
        <div className="space-y-4">
          <div className="relative">
            ...
            <input className="w-full rounded-[24px] border border-[var(--border)] bg-[var(--bg-soft)] py-4 pl-12 pr-4 outline-none transition focus:border-transparent focus:ring-2 focus:ring-amber-400/70" placeholder="Full Name" value={name} onChange={(e) => setName(e.target.value)} />
          </div>
          <div className="relative">
