  ...
  return (
    ...
    >
      <div className="text-center">
        <h1 className="text-3xl font-bold sm:text-4xl">{data?.title || "Terms and Conditions"}</h1>
      ...
      <Card className="rounded-[32px] p-6 sm:p-10 text-sm leading-relaxed text-[var(--muted)] space-y-6 whitespace-pre-wrap">
        {typeof data?.content === "string" ? (
          ...
          <p>The terms and conditions content is currently being updated by the administrator in the database.</p>
        )}
      </Card>
    </motion.div>
  );
