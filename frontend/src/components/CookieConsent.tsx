        ...
        >
          <div className="rounded-[24px] border border-[var(--border)] bg-[var(--bg-soft)]/90 p-5 shadow-2xl backdrop-blur-xl">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-base font-semibold text-[var(--text)]">We value your privacy</h3>
            </div>
            <p className="mt-3 text-sm leading-relaxed text-[var(--muted)]">
              We use cookies to improve your browsing experience and analyze our traffic. Please choose your preference.
            </p>
